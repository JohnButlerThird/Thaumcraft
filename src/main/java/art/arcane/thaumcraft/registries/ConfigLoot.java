...
public final class ConfigLoot {
    ...
    private static final DeferredRegister<MapCodec<? extends LootItemCondition>> REGISTRY_CONDITION = DeferredRegister.create(BuiltInRegistries.LOOT_CONDITION_TYPE, Thaumcraft.MOD_ID);
    ...
    public static final DeferredHolder<MapCodec<? extends LootItemCondition>, MapCodec<InfusionEnchantmentCondition>> CONDITION_INFUSION_ENCHANTMENT = condition(Loot.CONDITION_INFUSION_ENCHANTMENT, () -> InfusionEnchantmentCondition.CODEC);
    ...
    private static <T extends LootItemCondition> DeferredHolder<MapCodec<? extends LootItemCondition>, MapCodec<T>> condition(Identifier id, Supplier<MapCodec<T>> factory) {
        return REGISTRY_CONDITION.register(id.getPath(), factory);
    }

    private static <T extends IGlobalLootModifier> DeferredHolder<MapCodec<? extends IGlobalLootModifier>, MapCodec<T>> modifier(Identifier id, Supplier<MapCodec<T>> factory) {
